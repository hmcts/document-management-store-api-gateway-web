...
const {logging, logger} = require("./app/logging/dm-logger");

// routers DM GW & Public Law APP
const healthcheck = require("./app/router/dm-health")
const proxy = require("./app/router/dm-proxy")
const dmErrorHandle  = require("./app/router/dm-error")
